...
@router.post("/admin/users/{user_id}/add-days")
...
@router.post("/admin/users/{user_id}/refund")
...
@router.post("/admin/users/{user_id}/restore-access")
...
@router.post("/admin/invites/login")
...
@router.post("/admin/invites/logout")
