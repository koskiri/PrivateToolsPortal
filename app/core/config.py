...
REFERRAL_INVITE_ACCESS_DAYS = 3
SPONSOR_UPGRADE_AMOUNT_RUB = 5000
SPONSOR_UPGRADE_ACTION = "sponsor_upgrade"
SPONSOR_UPGRADE_DESCRIPTION = "Спонсорство OnlyUs"
SPONSOR_UPGRADE_GRANT_DAYS = 365
